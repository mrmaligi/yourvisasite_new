                ...
                >
                    <div className="glass-card p-8">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-slate-400">Join VisaIQ to manage your application</p>
                        </div>
                    ...
                    >
                        <Link
                            href="/lawyer/signup"
                            className="glass p-4 rounded-2xl hover:bg-white/10 transition group w-full max-w-xs"
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-400">Process visas for clients</p>
                                </div>
                            </div>
                        </Link>
                    </motion.div>
