    ...
    return (
        <div className="min-h-screen flex bg-slate-50">
            ...
            <div className="hidden lg:flex lg:w-1/2 p-12 flex-col justify-between bg-indigo-900">
                <div>
                    ...
                    >
                        ...
                        <p className="text-xl text-indigo-200 max-w-md">
                            Join thousands of others tracking their visa progress and connecting with experts.
                        </p>
                    </motion.div>
                </div>
                ...
                >
                    {[
                        { icon: Shield, text: "Bank-level encryption for your documents" },
                        { icon: Users, text: "Access to accredited migration lawyers" },
                        { icon: Scale, text: "AI-powered visa probability assessment" },
                    ].map((item, index) => (
                ...
                >
                    <div className="bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-slate-200">
                        ...
                        <div className="text-center mb-8">
                            <h2 className="text-2xl font-bold text-slate-900 mb-2 font-serif">Create Account</h2>
                    ...
                    >
                        <Link
                            href="/lawyer/signup"
                            className="w-full max-w-xs p-4 rounded-xl bg-white border border-slate-200 hover:border-emerald-500 hover:shadow-md transition group"
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500">Process visas for clients</p>
                                </div>
                            </div>
                        </Link>
                    </motion.div>
